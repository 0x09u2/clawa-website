  ...
  return (
    <Layout>
      <SEO
        ...
        description="Clawa Improvement Proposals (CIPs) define a standardized, community-driven process for proposing changes and initiatives within the Clawa ecosystem."
